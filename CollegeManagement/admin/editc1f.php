...
<?php
	...
	if( isset($_GET['edit']) )
	{
		...
		$res= mysql_query("SELECT * FROM c1f WHERE ID='$id'");
        ...
        if( isset($_POST['roll']) )
	{
		$newName = $_POST['roll'];
		$id  	 = $_POST['ID'];
		$sql     = "UPDATE c1f SET roll='$newName' WHERE ID ='$id'";
...
echo ("<SCRIPT LANGUAGE='JavaScript'>
        ...
        window.location.href='upc1f.php'
        </SCRIPT>");

		echo "<meta http-equiv='refresh' content='0;url= editc1f.php'>";
     ...
     if( isset($_POST['grade']) )
	{
		$newwri = $_POST['grade'];
		$id  	 = $_POST['ID'];
		$sql     = "UPDATE c1f SET grade='$newwri' WHERE ID ='$id'";
...
<form   action="editc1f.php" method="POST">
...
<td>
<input type="text" name="roll" value="<?php echo $row[1]; ?>"> <br/><br/> <td>
...
<td>
 ...
 <td> <input type="text" name="grade" value="<?php echo $row[2]; ?>">  <br/><br/>  </td>
