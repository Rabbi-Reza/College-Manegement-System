...
Please Input Teacher Data !!<br><br>

       <form style=" color:black; margin-left:340px; "name="form" method="post" action="inserttech.php">

    Full Name : <input name="num" type="text"><br><br>
	  Designation : <input name="des" type="text"><br><br>
 ...
 <ul class="pagination">
  <li> 
<a href='uptech.php'>All Inserted Datas  </a>
</li>
