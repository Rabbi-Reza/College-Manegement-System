...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `routs1` WHERE CONCAT(`date`) LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
 else {
    $query = "SELECT * FROM `routs1`";
    $search_result = filterTable($query);
}
...
<ul>
 ...
 <h1 style="color:black; ">Routine for Science , 1st year .. </h1>
<br>
                ...
                <tr style="color:black;background:skyblue;text-align:center;margin-left:250px;margin-top:25px">
                  <td><?php echo $row['date'];?></td>
					...
					<td><?php echo $row['5th'];?></td>
			         ...
			         <td><?php 	echo "   <a href='editr1s.php?edit=$row[ID]'>Edit</a> "; ?> </td>
