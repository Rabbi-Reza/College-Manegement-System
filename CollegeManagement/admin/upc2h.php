...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `c2h` WHERE CONCAT(`roll`) LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
 else {
    $query = "SELECT * FROM `c2h`";
    $search_result = filterTable($query);
}
...
<br>
 <form action="upc2h.php" method="post">
               ...
               <?php while($row = mysqli_fetch_array($search_result)):?>
                <tr style="color:black;background:skyblue;text-align:center;margin-left:250px;margin-top:25px">
                    ...
                    <td><?php echo $row['grade'];?></td>
			         ...
			         <td><?php 	echo "   <a href='editc2h.php?edit=$row[ID]'>Edit</a> "; ?> </td>
                   <td><?php 	echo "   <a href='deletec2h.php?del=$row[ID]'>Delete</a> "; ?> </td>
...
<a href='alladmin.php'>Admin page  </a>
 ...
 <ul class="pagination">
  <li> 
<a href='datac2h.php'>Insert New Data </a>
</li>
