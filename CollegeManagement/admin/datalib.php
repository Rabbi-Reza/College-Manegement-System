...
Please Input Book Data  !!<br><br>
       ...
       <form style=" color:black; margin-left:340px; "; name="form" method="post" action="insertlib.php">

    Book Name : <input name="num" type="text"><br><br>
	  Writer Name : <input name="wri" type="text"><br><br>
 ...
 <ul class="pagination">
  <li> 
<a href='uplib.php'>All Inserted Datas  </a>
</li>
