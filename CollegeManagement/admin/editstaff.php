...
<?php
	...
	if( isset($_GET['edit']) )
	{
		...
		$res= mysql_query("SELECT * FROM staffs WHERE ID='$id'");
        ...
        if( isset($_POST['name']) )
	{
		$newName = $_POST['name'];
		$id  	 = $_POST['ID'];
		$sql     = "UPDATE staffs SET name='$newName' WHERE ID ='$id'";
...
echo ("<SCRIPT LANGUAGE='JavaScript'>
		...
		echo "<meta http-equiv='refresh' content='0;url= editstaff.php'>";
	     ...
	     if( isset($_POST['dept']) )
	{
		$newdept = $_POST['dept'];
		$id  	 = $_POST['ID'];
		$sql     = "UPDATE staffs SET dept='$newdept' WHERE ID ='$id'";
...
echo ("<SCRIPT LANGUAGE='JavaScript'>
	     ...
	     if( isset($_POST['phone']) )
	{
		...
		$id  	 = $_POST['ID'];
		$sql     = "UPDATE staffs SET phone='$newphone' WHERE ID ='$id'";
...
<td>
<input type="text" name="dept" value="<?php echo $row[2]; ?>"> <br/><br/> </td>
</tr>
...
<td>
<input type="text" name="phone" value="<?php echo $row[3]; ?>"> <br/><br/>
</td>
