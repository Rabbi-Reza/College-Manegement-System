...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `c2f` WHERE CONCAT(`roll`) LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
 else {
    $query = "SELECT * FROM `c2f`";
    $search_result = filterTable($query);
}
...
<br>
 <form action="upc2f.php" method="post">
               ...
               <?php while($row = mysqli_fetch_array($search_result)):?>
                <tr style="color:black;background:skyblue;text-align:center;margin-left:250px;margin-top:25px">
                    ...
                    <td><?php echo $row['grade'];?></td>
			         ...
			         <td><?php 	echo "   <a href='editc2f.php?edit=$row[ID]'>Edit</a> "; ?> </td>
                   <td><?php 	echo "   <a href='deletec2f.php?del=$row[ID]'>Delete</a> "; ?> </td>
...
<a href='alladmin.php'>Admin page  </a>
 ...
 <ul class="pagination">
  <li> 
<a href='datac2f.php'>Insert New Data </a>
</li>
