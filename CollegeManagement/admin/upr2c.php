...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `routc2` WHERE CONCAT(`date`) LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
 else {
    $query = "SELECT * FROM `routc2`";
    $search_result = filterTable($query);
}
...
<ul>
 ...
 <h1 style="color:black; ">Routine for Commerce , 2nd year ..</h1>
<br>
                ...
                <tr style="color:black;background:skyblue;text-align:center;margin-left:250px;margin-top:25px">
                  <td><?php echo $row['date'];?></td>
					...
					<td><?php echo $row['5th'];?></td>
			         ...
			         <td><?php 	echo "   <a href='editr2c.php?edit=$row[ID]'>Edit</a> "; ?> </td>
