...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `staffs` WHERE CONCAT(`name`) LIKE '%".$valueToSearch."%'";
...
<ul>
 ...
 <h1 style="color:black; ">All Staff info .. </h1>
<br>
 <form action="upstaff.php" method="post">
      ...
      <!-- populate table from mysql database -->
                ...
                <tr style="color:black;background:skyblue;text-align:center;margin-left:250px;margin-top:25px">
					...
					<td><?php echo $row['phone'];?></td>
			         ...
			         <td><?php 	echo "   <a href='editstaff.php?edit=$row[ID]'>Edit</a> "; ?> </td>
                  <td><?php 	echo "   <a href='deletestaff.php?del=$row[ID]'>Delete</a> "; ?> </td>
...
<br /><br />
 <ul class="pagination">
  <li> 
<a href='datastaff.php'>Insert New Data </a>
</li>
