...
<?php
	...
	if( isset($_GET['edit']) )
	{
		...
		$res= mysql_query("SELECT * FROM routc2 WHERE ID='$id'");
        ...
        if( isset($_POST['date']) )
	{
		$newdate = $_POST['date'];
		$id  	 = $_POST['ID'];
		$sql     = "UPDATE routc2 SET date='$newdate' WHERE ID ='$id'";
...
echo ("<SCRIPT LANGUAGE='JavaScript'>
        ...
        window.location.href='upr2c.php'
        </SCRIPT>");

		echo "<meta http-equiv='refresh' content='0;url= editr2c.php'>";
     ...
     if( isset($_POST['1st']) )
	{
		$new1st = $_POST['1st'];
		$id  	 = $_POST['ID'];
		$sql     = "UPDATE routc2 SET 1st='$new1st' WHERE ID ='$id'";
...
echo ("<SCRIPT LANGUAGE='JavaScript'>
	     ...
	     if( isset($_POST['2nd']) )
	{
		$new2nd = $_POST['2nd'];
		$id  	 = $_POST['ID'];
		$sql     = "UPDATE routc2 SET 2nd='$new2nd' WHERE ID ='$id'";
...
echo ("<SCRIPT LANGUAGE='JavaScript'>
	     ...
	     if( isset($_POST['3rd']) )
	{
		$new3rd = $_POST['3rd'];
		$id  	 = $_POST['ID'];
		$sql     = "UPDATE routc2 SET 3rd='$new3rd' WHERE ID ='$id'";
...
echo ("<SCRIPT LANGUAGE='JavaScript'>
	     ...
	     if( isset($_POST['4th']) )
	{
		$newe4th = $_POST['4th'];
		$id  	 = $_POST['ID'];
		$sql     = "UPDATE routc2 SET 4th='$new4th' WHERE ID ='$id'";
...
echo ("<SCRIPT LANGUAGE='JavaScript'>
	     ...
	     if( isset($_POST['5th']) )
	{
		$newe5th = $_POST['5th'];
		$id  	 = $_POST['ID'];
		$sql     = "UPDATE routc2 SET 5th='$new5th' WHERE ID ='$id'";
...
echo ("<SCRIPT LANGUAGE='JavaScript'>
	     ...
	     if( isset($_POST['bk']) )
	{
		$newbk = $_POST['bk'];
		$id  	 = $_POST['ID'];
		$sql     = "UPDATE routc2 SET 5th='$newbk' WHERE ID ='$id'";
...
<form action="editr2c.php" method="POST">
