...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `teacher` WHERE CONCAT(`name`) LIKE '%".$valueToSearch."%'";
...
<ul>
 ...
 <h1 style="color:black; ">All Teacher info .. </h1>
<br>
      ...
      <!-- populate table from mysql database -->
                ...
                <tr style="color:black;background:skyblue;text-align:center;margin-left:250px;margin-top:25px">
					...
					<td><?php echo $row['phone'];?></td>
			         ...
			         <td><?php 	echo "   <a href='edittech.php?edit=$row[ID]'>Edit</a> "; ?> </td>
                  <td><?php 	echo "   <a href='deletetech.php?del=$row[ID]'>Delete</a> "; ?> </td>
...
<br /><br />
 <ul class="pagination">
  <li> 
<a href='datatech.php'>Insert New Data </a>
</li>
