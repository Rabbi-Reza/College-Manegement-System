...
Please Input Book Data  !!<br><br>

       <form style=" color:black; margin-left:340px; "; name="form" method="post" action="inserts1.php">
...
<td>  9.00 - 10.30 :  <input name="1st" type="text"><br><br>  </td>
	 
<td>
10.30 - 12.00 : <input name="2nd" type="text"><br><br>  </td>

 <td>
12.00 - 1.00:  <input name="bk" type="text" value ="Break"><br><br>  </td>
       
       
   <td>
1.00 - 2.30 : <input name="3rd" type="text" ><br><br>  </td>


 <td>
2.30 - 4.00 :   <input name="4th" type="text"><br><br>  </td>


 <td>
4.00 - 5.00 :   <input name="5th" type="text"><br><br>  </td>
 ...
 <ul class="pagination">
  <li> 
<a href='ups1.php'>All Inserted Datas  </a>
</li>
