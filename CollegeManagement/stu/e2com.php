...
<html>
<head><title>Engineering College </title>
...
<style>
	...
	<div style="background:#1E90FF ">
		...
		<h2 style="color:black; "> 2nd year , Commerce :</h2> <br> 
		
	 <div class="mainmenu">
<ul>
    <li id="blue_menu"><a href="ec2h.php">Half Yearly </a>
      
   </li>
	  
   <li id="blue_menu"><a href="ec2f.php">Year Final</a>
