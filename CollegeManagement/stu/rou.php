...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `books` WHERE CONCAT(`name`) LIKE '%".$valueToSearch."%'";
	...
	<div style="background:#D56116;margin-left: 150px;margin-top:25px">
		...
		<div class="fix slider">
			<div class="slider-wrapper theme-bar"/>
				...
				<img src="images/toystory.jpg" alt ="" title="#htmlcaption"/>
				<img src="images/walle.jpg" alt ="" title="#htmlcaption"/>
				<img src="images/up.jpg" alt =""title="#htmlcaption"/>
				<img src="images/nemo.jpg" alt =""title="#htmlcaption"/>
				</div>
				 <div id="htmlcaption" class="nivo-html-caption">
                <strong>This site</strong> is developed by <em>Md. Mahabub Bakhtiar</em> <a href="#"> details</a>. 
            </div>
			</div>
		</div>
	     <center>
...
<ul>
 ...
 <h1 style="color:black; ">All Books info .. </h1>
<br>
      ...
      <!-- populate table from mysql database -->
                ...
                <tr style="color:black;background:skyblue;text-align:center;margin-left:250px;margin-top:25px">
					...
					<td><?php echo $row['quantity'];?></td>
			         ...
			         <td><?php 	echo "   <a href='editlib.php?edit=$row[ID]'>Edit</a> "; ?> </td>
                  <td><?php 	echo "   <a href='deletelib.php?del=$row[ID]'>Delete</a> "; ?> </td>
...
<a href='datalib.php '>Insert New Data </a>
...
<a href='logout.php'>Log Out </a>
	...
	<div class="header_left_two">
		    <img src="flag.gif" height="100px" width="250px"/> <input id="input_one" type="text" name="" value="search"/>
			 <input id="input_two" type="button" value="OK"/>
...
<tr >
<td style="background:#D55E0F; border-radius:10px; text-align:center;color:#fff"><a href="" style="color:#fff;text-decoration:none">Admission</a></td>
<td style="background:#D55E0F; border-radius:10px; text-align:center;color:#fff"><a href="" style="color:#fff;text-decoration:none">Sports</a></td>
<td style="background:#D55E0F; border-radius:10px; text-align:center;color:#fff"><a href="" style="color:#fff;text-decoration:none">Cricket</a></td>
<td style="background:#D55E0F; border-radius:10px; text-align:center;color:#fff"><a href="" style="color:#fff;text-decoration:none">Students</a></td>
<td style="background:#D55E0F; border-radius:10px; text-align:center;color:#fff"><a href="" style="color:#fff;text-decoration:none">Teachers</a></td>
</tr>
</table>
</div>
